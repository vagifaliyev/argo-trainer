...
Please read [report.pdf](https://github.com/vagifaliyev/argo_trainer/blob/master/latexproj.pdf) for more information on code of conduct, development stages and algorthims.

## [retrive.py](https://github.com/vagifaliyev/argo_trainer/blob/master/argo_data/retrive.py)
...
## [labeler.py](https://github.com/vagifaliyev/argo_trainer/blob/master/argo_data/labeler.py)
...
## [authenticator.py](https://github.com/vagifaliyev/argo_trainer/blob/master/authenticator.py)
