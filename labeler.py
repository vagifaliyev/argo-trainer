...
def toggle_selector(event):
    ...
    plt.figtext(0.65, 0.01, txt, wrap=True, ha='left',va="bottom", fontsize=8)
...
def main():
    ...
    # if map has not been dowloaded yet, dowload 
    if os.path.isfile('./map.pickle') == False:
    ...
    for i in range(int(gen)):
        ...
        plt.figtext(0.85, 0.05, txt, wrap=True, ha='left',va="bottom", fontsize=8)
        # Author info
